  ...
  return (
    <>
      ...
      <div className="card p-3 mb-3 shadow p-3 mb-5 bg-body rounded border-0">
        ...
        <img src="https://images.unsplash.com/photo-1510519138101-570d1dca3d66?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1447&q=80" className="card-img-top rounded-3" alt="..." />
