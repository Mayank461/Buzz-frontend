    ...
    <>
      <div className="container ">
        <div className="d-flex justify-content-center align-items-center vh-100">
          <div class=" d-flex justify-content-center align-items-center row shadow-lg p-3 mb-5 bg-body rounded p-5 w-100 h-75 ">
            <div class="col-md-6">
              <div className="p-3">
            ...
            <div class="col-md-6">
              <div className="p-3">
                ...
                <input
                  type="email"
                  class="form-control border-0 border-bottom  mt-5"
                ...
                <div className="text-center d-grid gap-1 mt-3">
                  <button className="btn btn-lg px-5  mt-3 rounded-pill signup-btn-clr font-family fw-bolder font-size">
                    Sign In
                  </button>
                </div>
              </div>
