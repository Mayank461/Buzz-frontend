...
import { APICONFIRMREQ_URL, APIDELETEREQ_URL, APIGOOGLEAUTH_URL, APILOCALAUTH_URL, APISENTREQ_URL, APIUPDATEUSERDETAILS_URL } from "../config";
...
export const SendReq = (id,refresh) => {   
 ...
 export const postData = async (e,inputs,user,refresh,setRfresh,Refresh) => {
    e.preventDefault();
    if (
